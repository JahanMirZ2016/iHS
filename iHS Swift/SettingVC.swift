...
class SettingVC: UIViewController {
    ...
    private func dbUpdate() {
        ...
        DBManager.updateValuesOfSettingsDB(Type: "LanguageID", UpdateValue: "1")
        DBManager.updateValuesOfSettingsDB(Type: "ServerIP", UpdateValue: "")
        DBManager.updateValuesOfSettingsDB(Type: "ServerPort", UpdateValue: "")
        DBManager.updateValuesOfSettingsDB(Type: "CustomerID", UpdateValue: "")
        DBManager.updateValuesOfSettingsDB(Type: "MobileID", UpdateValue: "")
        DBManager.updateValuesOfSettingsDB(Type: "WiFiSSID", UpdateValue: "")
        DBManager.updateValuesOfSettingsDB(Type: "WiFiMac", UpdateValue: "")
        DBManager.updateValuesOfSettingsDB(Type: "CenterIP", UpdateValue: "")
        DBManager.updateValuesOfSettingsDB(Type: "CenterPort", UpdateValue: "")
        DBManager.updateValuesOfSettingsDB(Type: "LastMessageID", UpdateValue: "0")
        DBManager.updateValuesOfSettingsDB(Type: "ExKey", UpdateValue: "")
        DBManager.updateValuesOfSettingsDB(Type: "CustomerName", UpdateValue: "")
        DBManager.updateValuesOfSettingsDB(Type: "Register", UpdateValue: "0")
        DBManager.updateValuesOfSettingsDB(Type: "Ver", UpdateValue: "1")
    }
